...
- **板橋駅には、谷端川の別表記を施設名称として残す1980年の公的写真記録がある。** 板橋区公文書館の電子展示室は、昭和55年（1980年）撮影の「地下通路完成式典　栗原敬三区長の挨拶」（写真資料番号35566）を公開し、板橋駅地下通路の名称を「矢畑川自由地下通路ガード／矢畑川自由通路地下道架橋」と注記している。さらに、通常は「谷端川」の表記が多い一方、この地下道名では「矢畑川」を用いることを明記する。〔確認〕  
